...
let bang = m.key.id
await Skyzo.sendMessage(m.chat, {text: `@${m.sender.split("@")[0]} Maaf Kamu Akan Saya Keluarkan Dari Grup Ini Karna Admin/Owner Bot Menyalakan Fitur *Antilink* Grup Lain!`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnailUrl: "https://files.catbox.moe/y7ylwq.jpg", title: "╰┈➤LINK GRUP DETECTED ｣", previewType: "PHOTO"}}}, {quoted: m})
...
let delet = m.key.participant
let bang = m.key.id
await Skyzo.sendMessage(m.chat, {text: `@${m.sender.split("@")[0]} Maaf Pesan Kamu Saya Hapus Karna Admin/Owner Bot Menyalakan Fitur *Antilink* Grup Lain!`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnailUrl: "https://files.catbox.moe/y7ylwq.jpg", title: "╰┈➤ LINK GRUP DETECTED ｣", previewType: "PHOTO"}}}, {quoted: m})
await Skyzo.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: bang, participant: delet }})
}
}}

const qdoc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {documentMessage: {title: '⚡𝐉𝐮𝐬𝐭𝐢𝐧̋͢ 𝐎𝐟𝐟𝐢͠𝐜𝐢̋͢𝐚𝐥 𝐕𝟏 𝐕𝐢𝐩👻',jpegThumbnail: ""}}}

const qloc = {key: {participant: '0@s.whatsapp.net', ...(m.chat ? {remoteJid: `status@broadcast`} : {})}, message: {locationMessage: {name: `⚡𝐉𝐮𝐬𝐭𝐢𝐧̋͢𝐕𝟏 𝐕𝐢𝐩👻`,jpegThumbnail: ""}}}

const qloc2 = {key: {participant: '0@s.whatsapp.net', ...(m.chat ? {remoteJid: `status@broadcast`} : {})}, message: {locationMessage: {name: `⚡𝐉𝐮𝐬𝐭𝐢𝐧̋͢ 𝐕𝟏 𝐕𝐢𝐩👻`,jpegThumbnail: ""}}}
...
const qbug = {key: {remoteJid: 'status@broadcast', fromMe: false, participant: '0@s.whatsapp.net'}, message: {listResponseMessage: {title: `⚡𝐉𝐮𝐬𝐭𝐢𝐧̋͢ 𝐎𝐟𝐟𝐢͠𝐜𝐢̋͢𝐚l👻`
}}}
...
╞═𖠁 𝐈𝐍𝐅𝐎𝐑𝐌𝐀𝐓𝐈𝐎𝐍 𖠁═╡
︱ 𝐂𝐑𝐄𝐀𝐓𝐎𝐑 : ች𝐉𝐮𝐬𝐭𝐢𝐧 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥
︱ 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐂𝐑𝐈𝐏𝐓 : 𝐕𝐈𝐏
︱ 𝐕𝐄𝐑𝐒𝐈𝐎𝐍 : 𝐕.𝟏
╰────────➣
 ____________________________________
⚡𝐃𝐄𝐓𝐀𝐈𝐋 𝐌𝐄𝐍𝐔 𝐁𝐎𝐓 𝐉𝐮𝐬𝐭𝐢𝐧 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥 👻
 ____________________________________
...
*⚡名𝐌𝐚𝐢𝐧 𝐦𝐞𝐧𝐮圓─㍐👻*
  ...
  *⚡名𝐉𝐩𝐦 𝐌𝐞𝐧𝐮圓─㍐👻*
    ...
    ╰➤ • .jpm2 <text>
    ╰➤ • .jpmtesti <send testi>
    ╰➤ • .jpmht <text tagall mem>
    ╰➤ • .jpmpoll <text1/2/3>
    ╰➤ • .startjpm <send otomatis>
    ╰➤ • .setteksjpm <text>
    ╰➤ • .teksjpm <text justin>
    ╰➤ • .tespol <text1/2/3>
  ...
  *⚡名𝐆𝐫𝐨𝐮𝐩 𝐦𝐞𝐧𝐮圓─㍐👻*    
    ...
    *⚡名𝐎𝐰𝐧𝐞𝐫 𝐦𝐞𝐧𝐮圓─㍐👻*
    ...
    ╰➤ • .join <link>
 ____________________________________
 ⚡FOLOW CH FW DONG (JUSTIN OFFICIAL 👻)                                                                      
𝐥==============================𝐥
https://whatsapp.com/channel/0029Vb3N4BC2v1IvhrBupC0u 
`
...
m.reply("Berhasil Mengganti Foto Profil Bot JASA EDIT KE 𝗝𝘂𝘀𝘁𝗶𝗻✅")
} else return m.reply(example('dengan mengirim foto'))
}
break
...
ppuser = 'https://files.catbox.moe/y7ylwq.jpg'
}
...
break
case "vps": {
let teks = `📡𝐋𝐢𝐬𝐭 𝐕ps Byy Justin Official
━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
break
case "domain": {
let teks = `*List Harga Domain By Minxzyy Official*
...
break
case "panel": {
const teks = `📡Listt panel byy Justin Official⚡
━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- 𝐑𝐚𝐦 𝟐𝐆𝐁 𝐂𝐩𝐮 𝟓𝟎% = 𝟏.𝟎𝟎𝟎 
- 𝐑𝐚𝐦 𝟑𝐆𝐁 𝐂𝐩𝐮 𝟖𝟎% = 𝟐.𝟎𝟎𝟎
- 𝐑𝐚𝐦 𝟒𝐆𝐁 𝐂𝐩𝐮 𝟏𝟏𝟎% = 𝟑.𝟎𝟎𝟎 
- 𝐑𝐚𝐦 𝟓𝐆𝐁 𝐂𝐩𝐮 𝟏𝟑𝟎% = 𝟒.𝟎𝟎𝟎
- 𝐑𝐚𝐦 𝟔𝐆𝐁 𝐂𝐩𝐮 𝟏𝟓𝟎% = 𝟓.𝟎𝟎𝟎 
- 𝐑𝐚𝐦 𝟕𝐆𝐁 𝐂𝐩𝐮 𝟏𝟖𝟎% = 𝟔.𝟎𝟎𝟎
- 𝐑𝐚𝐦 𝟖𝐆𝐁 𝐂𝐩𝐮 𝟐𝟒𝟎% = 𝟕.𝟎𝟎𝟎
- 𝐑𝐚𝐦 𝟗𝐆𝐁 𝐂𝐩𝐮 𝟑𝟎𝟎% = 𝟗.𝟎𝟎𝟎
- 𝐑𝐚𝐦 𝐔𝐧𝐥𝐢𝐦𝐢𝐭𝐞𝐝 = 𝟏𝟎.𝟎𝟎𝟎
- 𝐑𝐞𝐬𝐞𝐥𝐥𝐞𝐫 𝐏𝐚𝐧𝐞𝐥 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝟕.𝟎𝟎𝟎
- 𝐀𝐝𝐦𝐢𝐧 𝐏𝐚𝐧𝐞𝐥 𝟏𝟓.𝟎𝟎𝟎 
- 𝐏𝐭 𝐏𝐚𝐧𝐞𝐥 𝟐𝟎.𝟎𝟎𝟎
- 𝐎𝐰𝐧𝐞𝐫 𝐏𝐚𝐧𝐞𝐥 𝟐𝟓.𝟎𝟎𝟎
...
var cap = `*Tiktok Downloader By Justin✅*`
...
break
case "owner": {
Skyzo.sendContact(m.chat, [owner], "Spam = Blok", m)
}
break
case "antilink": {
...
break
case "kik": case "kick": case "dor": case "piu": case "hus": case "cuh":  {
if (!isGroup) return m.reply(msg.group)
if (!isBotAdmin) return m.reply(msg.adminbot)
if (!isAdmin && !isOwner) return m.reply(msg.admin)
if (text || m.quoted) {
...
const teks = `*⚡Transaksi byy Justin Official✅*

*📦 Barang :* ${barang}
*💸 Nominal :* Rp${toRupiah(total2)}
*⏰ Waktu :* ${getTime().split("T")[0]}

_*terima kasih sudah telah mempercayakan Justin Official*_`
...
newsletterName: `Testimoni By Justin`
}}}, {quoted: qloc})
total += 1
} catch {}
await sleep(global.delayjpm)
...
break
case "addpanel": case "buatpanel": case "justin": {
if (!isOwner) return m.reply(msg.owner)
...
let messageText = "*🌐 LIST SERVER PANEL JUSTIN OFFICIAL*\n\n"
...
if (!isOwner) return m.reply(msg.owner)
let teks = `*｢ LIST ALL PAYMENT JUSTIN OFFICIAL ｣*
